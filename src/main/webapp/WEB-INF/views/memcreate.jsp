...
<form action="<c:url value='/savemem'/>" method='POST'>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-30" style="width: 400px">
            <input type="text" class="form-control" name="name" id="inName" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="inText" class="col-sm-2 col-form-label">Описание</label>
        <div class="col-sm-30" style="width: 400px;">
            <input type="text" class="form-control" id="inText" name="text" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="inAd" class="col-sm-2 col-form-label">Адрес</label>
        <div class="col-sm-30" style="width: 400px;">
            <input type="text" class="form-control" id="inAd" name="address" required>
        </div>
    </div>
